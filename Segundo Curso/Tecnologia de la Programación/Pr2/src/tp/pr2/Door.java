...
public boolean isInRoomaux(Room room, Directions where){ //Devuelve true si el parámetro de entrada la puerta pertenece a room en la dirección representada where.
